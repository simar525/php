                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu  pull-right" role="menu" aria-labelledby="user-options">
                                ...
                                <li>
                                    <a href="https://domain.storelax.xyz" target="_blank" rel="noopener noreferrer"><i class="fa fa-server"></i>   Add domain</a>
                                </li>
                                <li>
                                    <a href="https://support.storelax.co" target="_blank" rel="noopener noreferrer"><i class="fa fa-ticket"></i>   Support</a>
                                </li>
                                <li>
                                    <a href="https://storelax.co/branded-app" target="_blank" rel="noopener noreferrer"><i class="fa fa-rocket"></i> Get Mobile App</a>
                                </li>
                                <li class="divider"></li>
                                <li>
  				    <a href=""><i class="fa fa-database"></i>   Storage: Unlimited</a>
                                    <a href=""><i class="fa fa-archive"></i>   Products: Unlimited</a>
